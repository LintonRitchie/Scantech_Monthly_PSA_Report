...
class Ui_PSAHome(object):
    def setupUi(self, PSAHome):
        ...
        self.WelcomeText.setGeometry(QtCore.QRect(120, 140, 200, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        ...
        self.NewReportPB = QtWidgets.QPushButton(self.centralwidget)
        self.NewReportPB.setGeometry(QtCore.QRect(140, 270, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.NewReportPB.setFont(font)
        self.NewReportPB.setObjectName("NewReportPB")
        self.OpenReportPB = QtWidgets.QPushButton(self.centralwidget)
        self.OpenReportPB.setGeometry(QtCore.QRect(140, 320, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.AnalyserListComboBox = QtWidgets.QComboBox(self.centralwidget)
        self.AnalyserListComboBox.setGeometry(QtCore.QRect(80, 200, 271, 22))
        self.AnalyserListComboBox.setObjectName("AnalyserListComboBox")
        self.WelcomeText_2 = QtWidgets.QLabel(self.centralwidget)
        self.WelcomeText_2.setGeometry(QtCore.QRect(130, 170, 200, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.WelcomeText_2.setFont(font)
        self.WelcomeText_2.setObjectName("WelcomeText_2")
        self.AnalyserToBeProcessed = QtWidgets.QLabel(self.centralwidget)
        self.AnalyserToBeProcessed.setGeometry(QtCore.QRect(120, 240, 200, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.AnalyserToBeProcessed.setFont(font)
        self.AnalyserToBeProcessed.setObjectName("AnalyserToBeProcessed")
        self.CalibratorListComboBox = QtWidgets.QComboBox(self.centralwidget)
        self.CalibratorListComboBox.setGeometry(QtCore.QRect(90, 90, 271, 22))
        ...
        self.CalibratorListComboBox.addItem("")
        self.CalibratorListComboBox.addItem("")
        self.WelcomeText_3 = QtWidgets.QLabel(self.centralwidget)
        self.WelcomeText_3.setGeometry(QtCore.QRect(100, 60, 200, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
    ...
    def retranslateUi(self, PSAHome):
        ...
        self.AnalyserToBeProcessed.setText(_translate("PSAHome", "Select Analyser to process:"))
