...
class Ui_PSAHome(object):
    def setupUi(self, PSAHome):
        ...
        self.IssueBlank = QtWidgets.QPushButton(self.groupBox_2)
        self.IssueBlank.setGeometry(QtCore.QRect(60, 20, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.IssueBlank.setFont(font)
        self.IssueBlank.setObjectName("IssueBlank")
    ...
    def retranslateUi(self, PSAHome):
        ...
        self.IssueBlank.setText(_translate("PSAHome", "Issue Blank Report"))
        self.groupBox_3.setTitle(_translate("PSAHome", "Location of PSA Master File"))
        self.psamasterloc.setText(_translate("PSAHome", "TextLabel"))
        ...
        self.psadataloc.setText(_translate("PSAHome", "TextLabel"))
