...
# Form implementation generated from reading ui file 'C:\\Users\\l.ritchie\\PycharmProjects\\Scantech_Monthly_PSA_Report\\PSA_Home_Cal.ui'
#
...
class Ui_PSAHome(object):
    def setupUi(self, PSAHome):
        ...
        self.label.setGeometry(QtCore.QRect(31, 10, 354, 33))
        font = QtGui.QFont()
        ...
        self.groupBox.setGeometry(QtCore.QRect(610, 100, 161, 281))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(40, 150, 320, 230))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        ...
        self.ImportReportPB.setGeometry(QtCore.QRect(60, 60, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.PreviewReportPB.setGeometry(QtCore.QRect(60, 100, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.ExportReportPB.setGeometry(QtCore.QRect(60, 140, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.ExportReportPB.setFont(font)
        self.ExportReportPB.setObjectName("ExportReportPB")
        self.UpdateChecklistPB = QtWidgets.QPushButton(self.groupBox_2)
        self.UpdateChecklistPB.setEnabled(False)
        self.UpdateChecklistPB.setGeometry(QtCore.QRect(60, 180, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.UpdateChecklistPB.setFont(font)
        self.UpdateChecklistPB.setObjectName("UpdateChecklistPB")
        self.IssueBlankPB = QtWidgets.QPushButton(self.groupBox_2)
        self.IssueBlankPB.setGeometry(QtCore.QRect(60, 20, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.IssueBlankPB.setFont(font)
        self.IssueBlankPB.setObjectName("IssueBlankPB")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(40, 390, 730, 50))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.psamasterloc = QtWidgets.QLabel(self.groupBox_3)
        self.psamasterloc.setGeometry(QtCore.QRect(10, 18, 680, 20))
        self.psamasterloc.setText("")
        self.psamasterloc.setAlignment(QtCore.Qt.AlignCenter)
        self.psamasterloc.setObjectName("psamasterloc")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(40, 60, 320, 80))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.AnalyserListComboBox = QtWidgets.QComboBox(self.groupBox_4)
        self.AnalyserListComboBox.setGeometry(QtCore.QRect(60, 30, 200, 30))
        self.AnalyserListComboBox.setObjectName("AnalyserListComboBox")
        self.groupBox_5 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_5.setGeometry(QtCore.QRect(40, 450, 730, 50))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.psadataloc = QtWidgets.QLabel(self.groupBox_5)
        self.psadataloc.setGeometry(QtCore.QRect(10, 18, 680, 20))
        self.psadataloc.setText("")
        self.psadataloc.setAlignment(QtCore.Qt.AlignCenter)
        self.psadataloc.setObjectName("psadataloc")
        self.NewAnalyser = QtWidgets.QCheckBox(self.centralwidget)
        self.NewAnalyser.setGeometry(QtCore.QRect(380, 85, 200, 40))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.NewAnalyser.setFont(font)
        self.NewAnalyser.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.NewAnalyser.setObjectName("NewAnalyser")
        self.AutoSendReport = QtWidgets.QCheckBox(self.centralwidget)
        self.AutoSendReport.setGeometry(QtCore.QRect(380, 285, 200, 40))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.AutoSendReport.setFont(font)
        self.AutoSendReport.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.AutoSendReport.setObjectName("AutoSendReport")
        self.IncLastMonth = QtWidgets.QCheckBox(self.centralwidget)
        self.IncLastMonth.setGeometry(QtCore.QRect(380, 245, 200, 40))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.IncLastMonth.setFont(font)
        self.IncLastMonth.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.IncLastMonth.setChecked(True)
        self.IncLastMonth.setObjectName("IncLastMonth")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setEnabled(True)
        self.progressBar.setGeometry(QtCore.QRect(40, 515, 118, 23))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.StepLabel.setGeometry(QtCore.QRect(210, 505, 400, 40))
    ...
    def retranslateUi(self, PSAHome):
        ...
        self.UpdateChecklistPB.setText(_translate("PSAHome", "Update PSA Checklist"))
        self.IssueBlankPB.setText(_translate("PSAHome", "Issue Blank Report"))
        self.groupBox_3.setTitle(_translate("PSAHome", "Location of PSA Master File"))
        self.groupBox_4.setTitle(_translate("PSAHome", "Analyser to process"))
        self.groupBox_5.setTitle(_translate("PSAHome", "Location of PSA data"))
        self.NewAnalyser.setText(_translate("PSAHome", "Is this a New Analyser?\n"
"(Less than 2 reports produced)"))
        self.AutoSendReport.setText(_translate("PSAHome", "Automatically send report to \n"
"engineer?"))
        self.IncLastMonth.setText(_translate("PSAHome", "Include Last Report\'s Comments?"))
