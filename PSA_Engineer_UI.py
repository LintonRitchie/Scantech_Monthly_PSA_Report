...
fname = ""
print(" Starting Fname: " + str(fname))
...
class HomeWindow(QMainWindow,Ui_PSAHome):
    ...
    def connectSignalsSlots(self):
        ...
        self.ImportReportPB.released.connect(self.openReport)
    ...
    def updateReport(self):
        ...
        # Update UI
        self.page1.rep_analyser_data.setText(str(reportdata['Summary'][0]['AnalyserNo']))
        self.page1.rep_date_data.setText(repdate)
        self.page1.rep_serv_eng_data.setText(str(reportdata['Summary'][0]['ServEng']))
        self.page1.rep_app_data.setText(str(reportdata['Summary'][0]['Application']))
        self.page1.site_name.setText(str(reportdata['Summary'][0]['SiteName']))
        self.page1.period_data.setText(str(reportdata['Summary'][0]['Period']))
        self.page1.email_data.setText(str(reportdata['Summary'][0]['Email']))
    ...
    def UpdatePg6(self):
        ...
        self.page6.PlantPLCTable.setItem(0, 0, QTableWidgetItem(str(reportdata['PLCStatus'][0]['BeltRunning'][0]['Current'])))
        self.page6.PlantPLCTable.setItem(1, 0, QTableWidgetItem(str(reportdata['PLCStatus'][0]['ForceAnalyse'][0]['Current'])))
        self.page6.PlantPLCTable.setItem(2, 0, QTableWidgetItem(str(reportdata['PLCStatus'][0]['ForceStandardise'][0]['Current'])))
        ...
        self.page6.PlantPLCTable_2.setItem(0, 0, QTableWidgetItem(str(reportdata['AnalyserStatus'][0]['AnalyserOK'][0]['Current'])))
        self.page6.PlantPLCTable_2.setItem(1, 0, QTableWidgetItem(str(reportdata['AnalyserStatus'][0]['StandardsOK'][0]['Current'])))
        self.page6.PlantPLCTable_2.setItem(2, 0, QTableWidgetItem(str(reportdata['AnalyserStatus'][0]['IOControlOK'][0]['Current'])))
        self.page6.PlantPLCTable_2.setItem(3, 0, QTableWidgetItem(str(reportdata['AnalyserStatus'][0]['SpectraStable'][0]['Current'])))
        ...
        self.page6.PlantPLCTable_3.setItem(0, 0, QTableWidgetItem(str(reportdata['PLCResults'][0]['SystemOK'][0]['Current'])))
        self.page6.PlantPLCTable_3.setItem(1, 0, QTableWidgetItem(str(reportdata['PLCResults'][0]['SourceControlFault'][0]['Current'])))
        self.page6.PlantPLCTable_3.setItem(2, 0, QTableWidgetItem(str(reportdata['PLCResults'][0]['SourceOff'][0]['Current'])))
        self.page6.PlantPLCTable_3.setItem(3, 0, QTableWidgetItem(str(reportdata['PLCResults'][0]['SourceOn'][0]['Current'])))
        ...
        self.page6.PlantPLCTable_4.setItem(0, 0, QTableWidgetItem(str(reportdata['AnalyserConfiguration'][0]['AnalysisPeriod'][0]['Current'])))
        self.page6.PlantPLCTable_4.setItem(1, 0, QTableWidgetItem(str(reportdata['AnalyserConfiguration'][0]['AnalMinLoadLimit'][0]['Current'])))
        self.page6.PlantPLCTable_4.setItem(2, 0, QTableWidgetItem(str(reportdata['AnalyserConfiguration'][0]['StandardisePeriod'][0]['Current'])))
        ...
        self.page6.PlantPLCTable_5.setItem(0, 0, QTableWidgetItem(str(reportdata['Standardisation'][0]['FirstStandardTime'][0]['Current'])))
        self.page6.PlantPLCTable_5.setItem(1, 0, QTableWidgetItem(str(reportdata['Standardisation'][0]['MostRecentStandard'][0]['Current'])))
        self.page6.PlantPLCTable_5.setItem(2, 0, QTableWidgetItem(str(reportdata['Standardisation'][0]['NumStdPeriodsSinceClear'][0]['Current'])))
        self.page6.PlantPLCTable_5.setItem(3, 0, QTableWidgetItem(str(reportdata['Standardisation'][0]['NumStdPeriodsThisMnth'][0]['Current'])))
        ...
        self.page6.PlantPLCTable_6.setItem(0, 0, QTableWidgetItem(str(reportdata['SoftwareVersions'][0]['Product'][0]['Current'])))
        self.page6.PlantPLCTable_6.setItem(1, 0, QTableWidgetItem(str(reportdata['SoftwareVersions'][0]['CsSchedule'][0]['Current'])))
        ...
        self.page6.PlantPLCTable_7.setItem(0, 0, QTableWidgetItem(str(reportdata['DiskSpaceMem'][0]['DiskSpace'][0]['Current'])))
        self.page6.PlantPLCTable_7.setItem(1, 0, QTableWidgetItem(str(reportdata['DiskSpaceMem'][0]['PercDiskSpace'][0]['Current'])))
    ...
    def UpdateDetStab(self):
        ...
        for i in range(16):
            ...
            print(detnum)
            disabled = reportdata['DetectorStability'][0][detnum][0]['Enabled']
            print("Disabled = "+ str(disabled))
            # read in the detector Stability status from JSON
            stability = reportdata['DetectorStability'][0][detnum][0]['Stable']
    ...
    #
    def StdDate(self):
        stddate = reportdata['Standardisation'][0]['MostRecentStandard'][0]['Current']
    ...
    def DiskSpaceOK(self):
        diskspace = reportdata['DiskSpaceMem'][0]['PercDiskSpace'][0]['Current']
