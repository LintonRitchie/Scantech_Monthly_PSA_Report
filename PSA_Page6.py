...
class Ui_PSAPage6(object):
    def setupUi(self, PSAPage6):
        ...
        self.ClosePage = QtWidgets.QPushButton(self.centralwidget)
        self.ClosePage.setGeometry(QtCore.QRect(700, 180, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.ClosePage.setFont(font)
        self.ClosePage.setObjectName("ClosePage")
        ...
        self.ClosePage.released.connect(PSAPage6.close) # type: ignore
    ...
    def retranslateUi(self, PSAPage6):
        ...
        self.ClosePage.setText(_translate("PSAPage6", "Close"))
        self.Regenerate.setText(_translate("PSAPage6", "Regenerate Report"))
        self.psa_report_title_2.setText(_translate("PSAPage6", "Page 6"))
        self.PreviousPage.setText(_translate("PSAPage6", "Previous"))
        self.label_2.setText(_translate("PSAPage6", "Page Control"))
